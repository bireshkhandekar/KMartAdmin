                                                  ...
                                                  Container(
                                                    ...
                                                    child: FutureBuilder<
                                                      ...
                                                      builder:
                                                        ...
                                                        final cardGetCountsResponse =
                                                            snapshot.data!;
                                                        return Card(
                                                          clipBehavior: Clip
                                                              .antiAliasWithSaveLayer,
                                                          color:
                                                              const Color(0xFF708BFF),
                                                          elevation: 2.0,
                                                          shape:
                                                                      ...
                                                                      children: [
                                                                        Text(
                                                                          valueOrDefault<
                                                                              String>(
                                                                            getJsonField(
                                                                              cardGetCountsResponse.jsonBody,
                                                                              r'''$.order_count''',
                                                                            )?.toString(),
                                                                            '- -',
                                                                          ),
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        builder:
                                                                            (context) {
                                                                          final order = KMartApiGroup.getAllOrdersCall
                                                                                  .orders(
