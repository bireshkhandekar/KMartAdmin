                      ...
                      Align(
                        ...
                        child: Container(
                          ...
                          child: FutureBuilder<ApiCallResponse>(
                            future: KMartApiGroup.getItemsCall.call(
                              limit: 10,
                              pageno: _model.productPage,
                            ),
                            builder: (context, snapshot) {
                              ...
                              final columnGetItemsResponse = snapshot.data!;
                              return Column(
                                mainAxisSize: MainAxisSize.max,
                                ...
                                children: [
                                  wrapWithModel(
                                    ...
                                    child: TopbarWidget(
                                      pageName: 'Products',
                                      count: getJsonField(
                                        columnGetItemsResponse.jsonBody,
                                        r'''$.total_items_count''',
                                      ),
                                      tableName: 'Products',
                                    ),
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            Builder(
                                              builder: (context) {
                                                final product =
                                                    KMartApiGroup.getItemsCall
                                                            .items(
                                                              columnGetItemsResponse
                                                                  .jsonBody,
                                                            )
                                                            ?.toList() ??
                                                        [];
                                                                  ...
                                                                  FlutterFlowIconButton(
                                                                    ...
                                                                    onPressed:
                                                                      ...
                                                                      if (confirmDialogResponse) {
                                                                        _model.resultitemdisable = await KMartApiGroup
                                                                        ...
                                                                        if ((_model.resultitemdisable?.succeeded ??
                                                                            true)) {
                                                                          await showDialog(
                                                                            context:
                                                                                context,
                                                                            builder:
                                                                                (alertDialogContext) {
                                                                              return AlertDialog(
                                                                                content: const Text('Item has been disabled.'),
                                                                                actions: [
                                                                                  TextButton(
                                                                          ...
                                                                          await showDialog(
                                                                            ...
                                                                            builder:
                                                                                (alertDialogContext) {
                                                                              return AlertDialog(
                                                                                content: const Text('Item has been not disabled.'),
                                                                                actions: [
                                                                                  TextButton(
                                                                                    onPressed: () => Navigator.pop(alertDialogContext),
                                                                                    child: const Text('Ok'),
